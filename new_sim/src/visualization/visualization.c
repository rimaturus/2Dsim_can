...
//         float x_meter = cones[i].x_pixels * ppm;
//         float y_meter = cones[i].y_pixels * ppm;
//         al_draw_filled_circle(x_meter, y_meter, 5, color);
//     }
// }
...
//         if (distance < (config->car_params.wheelbase + cone_radius)) 
// 		{
//             collision = 1;
//             break;
//         }
...
// 	pthread_create(&canReceiveThreadId, NULL, receiveCANMessagesThread, receiveArgs);

// 	// Start the send car data thread
// 	pthread_create(&canSendThreadId, NULL, sendCarDataThread, sendArgs);

// 	// Start the timer
// 	al_start_timer(timer);

// 	// Install keyboard to check exit condition
